...
VALUES 
('Nike Air Max', 'Chaussures de sport confortables', 120.00, 10, 'https://example.com/nike-air-max.jpg'),
('Adidas Superstar', 'Chaussures classiques en cuir', 100.00, 15, 'https://example.com/adidas-superstar.jpg'),
('Puma RS-X', 'Chaussures lifestyle modernes', 90.00, 20, 'https://example.com/puma-rsx.jpg');
